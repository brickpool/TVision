...
my $i1 = TStatusItem->new( 'One', 0x1234, 1 );
my $i2 = TStatusItem->new( 'Two', 0x2345, 2 );
...
lives_ok {
  $status_def =
    TStatusDef->new( 0, 1 ) +
      TStatusItem->new( "One", 0x1000, 1 ) +
    TStatusDef->new( 2, 3 ) +
      TStatusItem->new( "Two", 0x2000, 2 ) +
      TStatusItem->new( "Three", 0x3000, 2 );
