...
my $submenu1 = TSubMenu->init( 'One', 0x1234, 0 );
isa_ok( $submenu1, TSubMenu, 'Object is of class TSubMenu' );

my $submenu2 = TSubMenu->init( 'Two', 0x5678, 0 );
...
my $menu_item = TMenuItem->init( 'Open', 2, 0x2345, 0, 'param', undef );
...
lives_ok {
  $submenu =
    TSubMenu->init( "Hello", 0x0000 ) +
      TMenuItem->init( "One", 1, 0x1000 ) +
      newLine() +
      TMenuItem->init( "~T~wo", 2, 0x2000, 0, "Alt-T" );
