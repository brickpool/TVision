...
=head3 Example
  ...
  01  # DEMOTBAC.pl
  02  # program demo TBackground
  03  
  04  use 
  05    TV::Objects; use TV::App; use TV::Views;
  06  
  07  { 
  08    package TSampleProgram; use parent ::TApplication;
  09      sub initDeskTop;
  10  }
  11  
  12  {
...
Listing C<TCMDSET> illustrates the use of a TCommandSet object.
  ...
  01  # TCMDSET.pl
  02  # Example using TCommandSet; from TVSHELL8.PAS
  03  
  04    my $commandsOn = TCommandSet->new()
  05    my $commandsOff = TCommandSet->new();
  06    ...
  07    $commandsOn += cmUseDOS + cmDelete;
  08    $commandsOff = $commandsOn->clone();
  09  
