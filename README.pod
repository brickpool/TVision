...
=head3 Message Box System
  ...
  +------------------+-------------------------+-----------+
  | messageBox()     | (missing)               | [ ]       |
  | messageBoxRect() | (missing)               | [ ]       |
  | inputBox()       | (missing)               | [ ]       |
  | inputBoxRect()   | (missing)               | [ ]       |
  +------------------+-------------------------+-----------+
...
Summary
  ...
  Total Borland classes/items tracked: 132
  Implemented:                         41
  Partial:                              7
  Missing:                             84

B<Notes>: Calculated from the full inventory of 132 Turbo Vision classes, 
