...
=head3 File/Directory Dialogs
  ...
  | TFileList       | TV::StdDlg::FileList       | [x]       |
  | TFileInfoPane   | TV::StdDlg::FileInfoPane   | [x]       |
  | TFileDialog     | TV::StdDlg::FileDialog     | [x]       |
  | TDirEntry       | TV::StdDlg::DirEntry       | [x]       |
  | TDirCollection  | TV::StdDlg::DirCollection  | [x]       |
  | TDirListBox     | (missing)                  | [ ]       |
  | TChDirDialog    | (missing)                  | [ ]       |
  +-----------------+----------------------------+-----------+

Win32 FindFirstRec class, implemented in C<TV::Drivers::FindFirstRec::Win32>.
...
Win32 THeapView, implemented in C<TV::Gadgets::HeapView::Win32>.
...
Summary
  ...
  Total Borland classes/items tracked: 106
  Implemented:                         76
  Partial:                              7
  Missing:                             23

B<Notes>: Calculated from the full inventory of ~100 Turbo Vision classes, 
